...
#$execProg = './computeStats.rb -n 1000 -p "./morpionSol PARAM"'     
$execProg = './computeStats.rb -n 300 -p "python3 mcts.py 10000 PARAM" -s 4'     
